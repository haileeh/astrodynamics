function A = stm_jacobian(x,y,z,mu)
...
fancyU = [Omega_xx, Omega_xy, Omega_xz; Omega_yx, Omega_yy, Omega_yz; Omega_zx, Omega_zy, Omega_zz];
Delta = zeros(3,3); Delta(1,2) = 1; Delta(2,1) = -1;
A = [zeros(3,3), eye(3); fancyU, 2*Delta];